...
const File = (props) => {
    ...
    return ( 
        <div className="col">
            <NavLink to={`/fileInfo/${props.info.hos_name}/${props.info.doc_name}`}className="file-wrap"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-file-earmark-text-fill file-icon" viewBox="0 0 16 16">
